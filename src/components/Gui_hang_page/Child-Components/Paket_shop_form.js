...
class PaketShopForm extends Component {
    componentDidMount() {
        moment.locale('vi');
        let days1 = [];
        let days2 = [];
            ...
            <div className="input-dia-chi-here">
                <form id="nhap-dia-chi" className={this.props.validated ? "needs-validation" +
                    ...
                    <div className="receiver-input-form">
                        ...
                        <div className="input-button">
                            <input type="text" className="form-control"
                                   placeholder="Mã số điểm giao nhận*"
                                   onChange={this.onHandleChangeReceiver}
                                   name="receiver_paket_shop"
                                   required/>
                            <div className="invalid-feedback">Vui lòng nhập mã số điểm giao nhận</div>
                        </div>
                        <div className="input-button">
                            <select
...
export default connect(mapStateToProps, null)(PaketShopForm);